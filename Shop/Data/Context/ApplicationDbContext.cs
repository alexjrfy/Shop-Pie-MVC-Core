...
namespace Shop.Data.Context
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //seed categories
            modelBuilder.Entity<Category>().HasData(new Category { Id = 1, Name = "Fruit pies", Description="" });
            modelBuilder.Entity<Category>().HasData(new Category { Id = 2, Name = "Cheese cakes", Description = "" });
            modelBuilder.Entity<Category>().HasData(new Category { Id = 3, Name = "Seasonal pies", Description = "" });
