...
{
    public partial class EnableOnModelCreating : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "", false, "Fruit pies" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "Enabled", "Name" },
                values: new object[] { 2, "", false, "Cheese cakes" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "Enabled", "Name" },
                values: new object[] { 3, "", false, "Seasonal pies" });
